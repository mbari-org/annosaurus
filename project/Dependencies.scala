...
object Dependencies {
    ...
    val hibernateVersion             = "7.3.0.Final" // See https://github.com/mbari-org/annosaurus/issues/47
    ...
    lazy val mssqlserver             = "com.microsoft.sqlserver"        % "mssql-jdbc"                 % "13.4.0.jre11"
