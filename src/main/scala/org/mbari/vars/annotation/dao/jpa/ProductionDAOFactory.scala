...
object ProductionDAOFactory extends JPADAOFactory {
  ...
  private[this] val productName = Try(config.getString("org.mbari.vars.annotation.database.production.name")).getOrElse("Auto")
  ...
  lazy val entityManagerFactory: EntityManagerFactory = {
    val driver = config.getString("org.mbari.vars.annotation.database.production.driver")
    val url = config.getString("org.mbari.vars.annotation.database.production.url")
    val user = config.getString("org.mbari.vars.annotation.database.production.user")
    val password = config.getString("org.mbari.vars.annotation.database.production.password")
