 ...
 */
trait DAOFactory[IM <: ImagedMoment, OBS <: Observation, A <: Association, IR <: ImageReference, CAD <: CachedAncillaryDatum, CMI <: CachedVideoReferenceInfo, ID <: ImagedMoment] {
