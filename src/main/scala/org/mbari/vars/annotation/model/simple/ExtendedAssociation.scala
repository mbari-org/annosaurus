 ...
 */
case class ExtendedAssociation(@Expose(serialize = true) uuid: UUID,
...
object ExtendedAssociation {
  def apply(a: Association): ExtendedAssociation = {
    ...
    ExtendedAssociation(a.uuid, a.observation.uuid, a.linkName, a.toConcept, a.linkValue, a.mimeType)
  }
}
