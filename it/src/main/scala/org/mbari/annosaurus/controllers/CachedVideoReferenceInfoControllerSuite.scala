...
trait CachedVideoReferenceInfoControllerSuite extends BaseDAOSuite {
    ...
    test("create") {
        ...
        val expected = CachedVideoReferenceInfo
            .from(vi)
    ...
    test("update") {
        ...
        val updated  = existing.copy(
            missionContact = Option("new contact"),
            platformName = Some("new platform"),
            missionId = Some("new mission")
        )
