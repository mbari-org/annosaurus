...
/** This is just a class to help GSON generate a list of values from an array. Note that GSON chokes
  * on this and assigns a Java ArrayList to the values. So don't used the generic ValueArray
  *
  * @author
  *   Brian Schlining
