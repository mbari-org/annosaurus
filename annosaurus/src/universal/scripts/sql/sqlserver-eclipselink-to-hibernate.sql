...
update
    dbo.imaged_moments
set
    recorded_timestamp = convert(datetime2, recorded_timestamp) AT TIME ZONE 'UTC'
go
...
update
    dbo.observations
set
    observation_timestamp = convert(datetime2, observation_timestamp) AT TIME ZONE 'UTC'
go
-- Add audit tables
